 ...
 * 
 */
public class GenotypeAdapter extends Genotype implements Serializable {
	 ...
	 */
	public GenotypeAdapter(Configuration a_activeConfiguration,
	...
	public GenotypeAdapter(Genotype genotype, PFSInfo info) throws InvalidConfigurationException {
...
//			((ConcurrentLearner)bulkFunction).printOutputs();
	 ...
	 */
	public static GenotypeAdapter randomInitialGenotype(
		...
		return new GenotypeAdapter(a_activeConfiguration, chroms, info);
	}
